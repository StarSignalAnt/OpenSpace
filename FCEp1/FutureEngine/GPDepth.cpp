...
Diligent::float4x4 GLMToDiligentMatrix3D2(const glm::mat4& mat)
{
...
void GPDepth::Bind(glm::mat4 world, glm::mat4 view, glm::mat4 proj, NodeCamera* cam, Mesh3DBuffer* buffer) {
    // Ensure that the constant buffer is up-to-date for the current frame
    {
        ...
        CBConstants[0].world = GLMToDiligentMatrix3D2(world);
        CBConstants[0].view = GLMToDiligentMatrix3D2(view);
        CBConstants[0].proj = GLMToDiligentMatrix3D2(proj);
...
void GPDepth::Render(Mesh3DBuffer* buffer) {
