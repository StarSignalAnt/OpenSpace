...
GPDOF::GPDOF() {
    ...
    m_VSPath = "engine/deShader/dof.vsh";
    m_PSPath = "engine/deShader/dof.psh";
    CreatePL();
...
void GPDOF::CreatePL() {
    ...
    PSOCreateInfo.PSODesc.Name = "Blur PSO";
  ...
  //  ShaderCI.Macros = { Macros, _countof(Macros) };
    ...
    RefCntAutoPtr<IShader> pVS;
    {
        ...
        CBDesc.Size = sizeof(DOFConstants);
...
void GPDOF::Bind(MeshBuffer* buffer, Texture2D* texture) {


    {
        MapHelper<DOFConstants> CBConstants(FutureApp::m_Inst->GetContext(), m_Constants, MAP_WRITE, MAP_FLAG_DISCARD);
        CBConstants[0].mvp = m_World;
        CBConstants[0].dof =float4(0.15f, 0.15, 0,0);
    }
    ...
    m_SRB->GetVariableByName(SHADER_TYPE_PIXEL, "g_Texture2")->Set(m_AuxTexture->GetView());
...
void GPDOF::Render(MeshBuffer* buffer) {
...
//void GPDOF::SetBlctor(float factor) {
