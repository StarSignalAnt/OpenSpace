...
GPCombine::GPCombine() {
    ...
    m_VSPath = "engine/deShader/combine.vsh";
    m_PSPath = "engine/deShader/combine.psh";
    CreatePL();
...
void GPCombine::CreatePL() {
    ...
    PSOCreateInfo.PSODesc.Name = "Combine PSO";
...
void GPCombine::Bind(MeshBuffer* buffer, Texture2D* texture) {
...
void GPCombine::Render(MeshBuffer* buffer) {
