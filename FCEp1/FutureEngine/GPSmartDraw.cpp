...
GPSmartDraw::GPSmartDraw() {

	m_VSPath = "engine/deShader/colored.vsh";
	m_PSPath = "engine/deShader/colored.psh";
	CreatePL();

}

void GPSmartDraw::CreatePL() {
...
void GPSmartDraw::Bind(MeshBuffer* buffer,Texture2D* texture) {
...
void GPSmartDraw::Render(MeshBuffer* buffer) {
