...
Diligent::float4x4 GLMToDiligentMatrix11(const glm::mat4& mat)
{
...
void MaterialPBR3D::InitPipeline() {
  ...
  //  ShaderCI.Macros = { Macros, _countof(Macros) };
    ...
    RefCntAutoPtr<IShader> pVS;
    {
        ...
        CBDesc.Size = sizeof(PBR3DConstants);
...
void MaterialPBR3D::Bind() {

    {
        MapHelper<PBR3DConstants> CBConstants(FutureApp::m_Inst->GetContext(), m_Constants, MAP_WRITE, MAP_FLAG_DISCARD);
        CBConstants[0].world = GLMToDiligentMatrix11(m_RenderMatrices[0]);
        CBConstants[0].view = GLMToDiligentMatrix11(m_RenderMatrices[1]);
        CBConstants[0].proj = GLMToDiligentMatrix11(m_RenderMatrices[2]);
