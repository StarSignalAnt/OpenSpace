...
GPBlur::GPBlur() {
    ...
    m_VSPath = "engine/deShader/blur.vsh";
    m_PSPath = "engine/deShader/blur.psh";
    CreatePL();
...
void GPBlur::Bind(MeshBuffer* buffer, Texture2D* texture) {
...
void GPBlur::Render(MeshBuffer* buffer) {
